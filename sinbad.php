<?php
    ...
    // fatch all data from registrtion form 
    if(isset($_POST['submit'])){
        ...
        // echo $name ." ".$email." ".$phone." ".$whatsapp." ".$password." ".$cpassword;
        ...
        if($email_count>0){
            ...
            <script>
                ...
                window.location.href="/sinbad.php";
            </script>
            <?php  
        }
        ...
        $query="insert into users(name,email,phone,whatsapp,password) values('$name','$email','$phone','$whatsapp','$pass')";
        ...
        <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-xl">
                ...
                <form class="space-y-6" action="" method="POST">
                    ...
                    <div class="mt-1">
                        <input id="phone" name="phone" type="phone" autocomplete="phone" required class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                    </div>
                    </div>
                    <div>
                    <label for="whatsapp" class="block text-sm font-medium text-gray-700">WhatsApp Number</label>
                    <div class="mt-1">
                        <input id="whatsapp" name="whatsapp" type="whatsapp" autocomplete="whatsapp" required class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                    </div>
                    </div>
                    ...
                    <div class="mt-1">
                        <input id="cpassword" name="cpassword" type="password" autocomplete="current-cpassword" required class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                    </div>
                    </div>
